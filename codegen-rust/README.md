...
- API version: 1.0.0
- Build date: 2020-08-04T00:24:45.081793200+08:00[Asia/Shanghai]
...
```
cargo run --example client UserGet
cargo run --example client UserLoginPost
```
...
------------- | ------------- | -------------
[****](docs/default_api.md#) | **GET** /user | 获取用户信息
[****](docs/default_api.md#) | **POST** /user/login | 
